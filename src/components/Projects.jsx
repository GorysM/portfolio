  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="inline-flex items-center justify-center gap-2 h-11 px-5 rounded-xl bg-neutral-900 text-white font-medium hover:bg-neutral-700 transition-colors"
      >
        View Live Project
